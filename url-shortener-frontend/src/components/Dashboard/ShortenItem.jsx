      ...
      <div className="flex sm:flex-row flex-col sm:justify-between w-full sm:gap-0 gap-5 py-5">
        ...
        <div className="flex flex-1 sm:justify-end items-center gap-4 flex-wrap">
          <div
            ...
            className="flex cursor-pointer gap-1 items-center bg-gradient-to-r from-blue-500 to-purple-500 py-2 font-semibold shadow-md shadow-slate-500 px-6 rounded-md text-white"
          >
          ...
          <div className="flex flex-col items-center gap-2 mt-2">
            <QRCode ref={qrRef} id={`qr-${shortUrl}`} value={shortUrlFull} size={128} />
            <button
              onClick={handleDownload}
              className="bg-blue-600 hover:bg-blue-700 text-white px-3 py-1 rounded-md text-sm shadow"
            >
              Download QR
            </button>
          </div>
